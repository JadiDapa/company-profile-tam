...
export default function FindUs() {
  return (
    <section id="about" className="relative w-full px-4 py-20 lg:px-28 lg:py-40">
      ...
      />
      <FadeIn className="mb-8 flex flex-col items-start gap-4 lg:mb-0 lg:flex-row lg:items-center lg:justify-between">
        <div className="">
          <div className="flex max-w-fit items-stretch gap-0.5">
            ...
            <div className="text-primary border-primary -skew-x-12 border-2 bg-transparent px-4 py-0.5">
              <p className="skew-x-12 font-medium">Location</p>
            </div>
          </div>
      ...
      <FadeIn
        delay={0.1}
        className="relative mt-6 flex h-64 w-full flex-1 items-center justify-center overflow-hidden rounded-md lg:mt-0 lg:h-80"
      >
        <iframe
          ...
          title="Taruna Anugrah Mandiri office location on Google Maps"
